...
Don't want to build from source? Get the signed installer, lifetime updates and setup support for a one-time payment at [onetimesuite.com/pdfsmith](https://onetimesuite.com/pdfsmith/) — same app, MIT source right here.
